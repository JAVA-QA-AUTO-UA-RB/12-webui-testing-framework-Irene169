...
public class HorizontalSliderSteps {
    ...
    public void iMoveTheSliderTo(double targetValue) {
        initialValue = Double.parseDouble(sliderPage.getValue());
        sliderPage.moveSliderTo(String.valueOf(targetValue));
        updatedValue = Double.parseDouble(sliderPage.getValue());
    }
